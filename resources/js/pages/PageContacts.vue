    ...
    methods : {
        submitMessage(){
            ...
            axios.post('/api/leads/', {    // creiamo la rotta come primo argomento; i dati come secondo argomento
                ...
                .then(res => {                               // inviati i dati dal form al backend dobbiamo stare in ascolto per dire all utente se sia andato tutto a posto
                ...
                .finally(data => this.sending = false);     // funzione che viene eseguita dopo il then e dopo il catch; viene sempre eseguito e ripristina il bottone
        },
